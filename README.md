...
[模组提取的文本、翻译就在本仓库：`Game/` 与 `Mods/<模组>/` 目录](https://github.com/031fox-ui/a.chs.mod/tree/main/Mods)
...
[GitHub 直接下载（最新 Release，比较吃网络）](https://github.com/031fox-ui/a.chs.mod/releases/latest/download/A.Multi_Mod.Chinese.Localization.dll)
...
尝试修复多人联机中控制台自动补全不显示“玩家名字”和“@c 等”的问题。自己能正常显示，没测试别人名字是否显示
