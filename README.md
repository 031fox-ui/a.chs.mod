...
（正在大改，从txt转为json，仓库里会上传原始英文或其他语言的“ORIG”文件夹，“CHS”文件夹是模组读取、下载的翻译文件。正在测试……）

目前：v0.0.2

直接把下载好的.dll文件放入游戏的"Casualties Unknown Demo\BepInEx\plugins"文件夹即可。

[蓝奏云下载：https://wwann.lanzout.com/tp/i1suW3tdf9p](https://wwann.lanzout.com/tp/i1suW3tdf9p)　　密码：2jrn

[腾讯微云下载：https://share.weiyun.com/Z3mQYQTW](https://share.weiyun.com/Z3mQYQTW)
